...
app.get('/health', (_req, res) => {
  res.json({ ok: true, service: 'Réussite Concours BF payments', time: new Date().toISOString() });
});
...
app.listen(PORT, '0.0.0.0', () => {
  console.log(`Réussite Concours BF payments backend listening on 0.0.0.0:${PORT}`);
});
